...
ALTER TABLE public.company_dim OWNER to aroobs;
ALTER TABLE public.skills_dim OWNER to aroobs;
ALTER TABLE public.job_postings_fact OWNER to aroobs;
ALTER TABLE public.skills_job_dim OWNER to aroobs;
